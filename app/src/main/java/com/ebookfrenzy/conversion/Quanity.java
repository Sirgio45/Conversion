...
/**
 * Created by sergio on 12/6/2016.
 */


public class Quanity extends MainActivity
{
    ...
    public static enum Unit {
        ...
        private Unit(double inTsp) {
            this.byBaseUnit = inTsp;
                ...
                //onverts any other unit value to the number of tsps
    ...
    public Quanity(double value, Unit unit) {
        super();
        this.value = value;
        this.unit = unit;
    }
            // onverts from tsp to the desired unit type
    public Quanity to(Unit newUnit) {
        Unit oldUnit = this.unit;
        return new Quanity(newUnit.fromBaseUnit(oldUnit.toBaseUnit(value)), newUnit);
    }
